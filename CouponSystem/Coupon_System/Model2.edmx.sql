...
-- --------------------------------------------------
-- Date Created: 04/26/2015 22:17:04
...
GO
IF OBJECT_ID(N'[dbo].[FK_Users_CustomerCatalogCoupons_SocialNetworkCoupon]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CatalogCoupons_SocialNetworkCoupon] DROP CONSTRAINT [FK_Users_CustomerCatalogCoupons_SocialNetworkCoupon];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_CatalogCoupons_SocialNetworkCouponCatalogCoupon]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CatalogCoupons_SocialNetworkCoupon] DROP CONSTRAINT [FK_CatalogCoupons_SocialNetworkCouponCatalogCoupon];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_OrderedCouponUsers_Customer]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Users_Customer] DROP CONSTRAINT [FK_OrderedCouponUsers_Customer];
GO
